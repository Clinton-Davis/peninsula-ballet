...
- **Events Page:** The events page lists all the events the ballets school has taken part in. Each event opens up with images or videos.
...
3. Clone the repository using HTTPS, under "Clone with HTTPS", click. To clone the repository using an SSH key, including a certificate issued by your organisation's SSH certificate authority, click Use SSH, then click.
4. Open Git Bash.

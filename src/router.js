...
import HomeScroll from "./components/pages/HomeScroll.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/welcome", name: "welcome", component: HomeScroll },
    { path: "/teachers", redirect: { path: "/welcome", hash: "#teachers" } },
    { path: "/studios", redirect: { path: "/welcome", hash: "#studios" } },
    {
      path: "/enrolment",
      redirect: { path: "/welcome", hash: "#enrolment" },
    },
    { path: "/attire", redirect: { path: "/welcome", hash: "#attire" } },
